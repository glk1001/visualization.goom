...
extern int getIntSetting(
    FILE* f, const char* parent, const char* settingName, const char* srceFilename, int lineNum);
static void saveIntSetting(FILE* f,
                           const char* parent,
                           const char* settingName,
                           int value,
                           const char* srceFilename,
                           int lineNum);
extern float getFloatSetting(
    FILE* f, const char* parent, const char* settingName, const char* srceFilename, int lineNum);
static void saveFloatSetting(FILE* f,
                             const char* parent,
                             const char* settingName,
                             float value,
                             const char* srceFilename,
                             int lineNum);
extern int getIndexedIntSetting(FILE* f,
                                const char* parent,
                                const char* settingName,
                                int i,
                                const char* srceFilename,
                                int lineNum);
static void saveIndexedIntSetting(FILE* f,
                                  const char* parent,
                                  const char* settingName,
                                  int i,
                                  int value,
                                  const char* srceFilename,
                                  int lineNum);
extern float getIndexedFloatSetting(FILE* f,
                                    const char* parent,
                                    const char* settingName,
                                    int i,
                                    const char* srceFilename,
                                    int lineNum);
static void saveIndexedFloatSetting(FILE* f,
                                    const char* parent,
                                    const char* settingName,
                                    int i,
                                    float value,
...
static inline void saveIntSetting(FILE* f,
                                  const char* parent,
                                  const char* settingName,
                                  int value,
                                  const char* srceFilename,
...
static inline void saveFloatSetting(FILE* f,
                                    const char* parent,
                                    const char* settingName,
                                    float value,
                                    const char* srceFilename,
...
static inline void saveIndexedIntSetting(FILE* f,
                                         const char* parent,
                                         const char* settingName,
                                         int i,
                                         int value,
...
static inline void saveIndexedFloatSetting(FILE* f,
                                           const char* parent,
                                           const char* settingName,
                                           int i,
                                           float value,
