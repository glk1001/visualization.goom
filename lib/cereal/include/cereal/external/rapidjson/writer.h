...
enum WriteFlag
{
  ...
  kWriteDefaultFlags =
      CEREAL_RAPIDJSON_WRITE_DEFAULT_FLAGS //!< Default write flags. Can be customized by defining CEREAL_RAPIDJSON_WRITE_DEFAULT_FLAGS
};
...
public:
  ...
  bool EndObject(SizeType memberCount = 0)
  {
    ...
    CEREAL_RAPIDJSON_ASSERT(0 == level_stack_.template Top<Level>()->valueCount %
