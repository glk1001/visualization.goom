...
#define CEREAL_RAPIDJSON_ENABLEIF(cond) \
  typename ::CEREAL_RAPIDJSON_NAMESPACE::internal::EnableIf<CEREAL_RAPIDJSON_REMOVEFPTR_( \
      cond)>::Type* = NULL

#define CEREAL_RAPIDJSON_DISABLEIF(cond) \
  typename ::CEREAL_RAPIDJSON_NAMESPACE::internal::DisableIf<CEREAL_RAPIDJSON_REMOVEFPTR_( \
      cond)>::Type* = NULL

#define CEREAL_RAPIDJSON_ENABLEIF_RETURN(cond, returntype) \
  typename ::CEREAL_RAPIDJSON_NAMESPACE::internal::EnableIf< \
      CEREAL_RAPIDJSON_REMOVEFPTR_(cond), CEREAL_RAPIDJSON_REMOVEFPTR_(returntype)>::Type
