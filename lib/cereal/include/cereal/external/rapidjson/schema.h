...
#define CEREAL_RAPIDJSON_STRING_(name, ...) \
  ...
  CEREAL_RAPIDJSON_STRING_(PatternProperties,
                           'p',
                           'a',
                           't',
                           't',
                           ...
                           'e',
                           's')
  CEREAL_RAPIDJSON_STRING_(AdditionalProperties,
                           'a',
                           'd',
                           'd',
                           'i',
  ...
  CEREAL_RAPIDJSON_STRING_(ExclusiveMinimum,
                           'e',
                           'x',
                           'c',
                           'l',
                           ...
                           'u',
                           'm')
  CEREAL_RAPIDJSON_STRING_(ExclusiveMaximum,
                           'e',
                           'x',
                           'c',
                           'l',
...
#define CEREAL_RAPIDJSON_SCHEMA_HANDLE_VALUE_(method, arg1, arg2) \
  ...
  {
    CEREAL_RAPIDJSON_SCHEMA_HANDLE_VALUE_(String, (CurrentContext(), str, length, copy),
                                          (str, length, copy));
  }
