...
#define CEREAL_RAPIDJSON_VERSION_STRING \
  CEREAL_RAPIDJSON_STRINGIFY(CEREAL_RAPIDJSON_MAJOR_VERSION.CEREAL_RAPIDJSON_MINOR_VERSION \
...
#define CEREAL_RAPIDJSON_SETPOINTER(type, p, x) \
  (p = reinterpret_cast<type*>( \
       (reinterpret_cast<uintptr_t>(p) & \
        static_cast<uintptr_t>(CEREAL_RAPIDJSON_UINT64_C2(0xFFFF0000, 0x00000000))) | \
...
#define CEREAL_RAPIDJSON_STATIC_ASSERT(x) static_assert(x, CEREAL_RAPIDJSON_STRINGIFY(x))
#endif // C++11
...
#if defined(__clang__) || (defined(CEREAL_RAPIDJSON_GNUC) && \
...
#endif
#elif (defined(CEREAL_RAPIDJSON_GNUC) && \
